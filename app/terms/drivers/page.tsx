export default function DriverTerms() {
  return (
    <main className="min-h-screen bg-gray-50 p-6 max-w-2xl mx-auto space-y-6 text-gray-800">
      <h1 className="text-2xl font-bold text-gray-900">Terms &amp; Conditions — Ambulance Partners</h1>
      ...
      <section className="space-y-2">
        ...
        <p>Ambulance Network ("the Platform") is a dispatch and technology service that connects riders with independently owned and operated ambulances. The Platform does not own, operate, or employ any ambulance, driver, or medical personnel. Each ambulance on the network remains the sole responsibility of its owner/sponsor and driver.</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-semibold text-lg text-gray-900">2. Platform Fees</h2>
        <p>Participation requires a recurring platform usage fee, payable daily, weekly, or monthly at the partner's choice, at the rates published in the Platform's admin system from time to time. Fees are payable in advance via the designated Mobile Money merchant channel. An ambulance's subscription must be active and confirmed by the Platform before it will receive trip requests. Fees already paid for a period are non-refundable once that period has begun, except at the Platform's discretion.</p>
      </section>
