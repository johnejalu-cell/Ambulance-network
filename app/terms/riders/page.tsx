export default function RiderTerms() {
  return (
    <main className="min-h-screen bg-gray-50 p-6 max-w-2xl mx-auto space-y-6 text-gray-800">
      <h1 className="text-2xl font-bold text-gray-900">Terms &amp; Conditions — Riders</h1>
      <p className="text-sm text-gray-500 italic">Draft — for legal review before publication. Not yet reviewed by a lawyer.</p>

      <section className="space-y-2 bg-red-50 border border-red-200 rounded-lg p-4">
        <p className="font-semibold text-red-800">In a life-threatening emergency, also call Uganda's national emergency lines directly. This app is a dispatch tool and cannot guarantee an ambulance will be available or arrive within any specific time.</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-semibold text-lg text-gray-900">1. Nature of the Service</h2>
        <p>Ambulance Network ("the Platform") is a technology service that helps you locate and request the nearest available ambulance from a network of independently owned and operated ambulances. The Platform does not itself own or operate any ambulance, employ any driver or medical personnel, or provide medical care. Each ambulance and its crew are operated by an independent third party.</p>
      </section>

      <section className="space-y-2">
        <h2 className="font-semibold text-lg text-gray-900">2. No Guarantee of Availability or Response Time</h2>
        <p>Dispatch depends on which ambulances are online, available, and within range at the time of your request. The Platform does not guarantee that an ambulance will be available, that a driver will accept your request, or any particular arrival time. If no ambulance responds, you must seek emergency care through other means immediately.</p>
      </section>
